  ...
  return (
    <form onSubmit={handlesubmit} className='flex flex-col w-full items-start gap-3'>
         <div>
            ...
            <div className='flex gap-2'>
                ...
                <label htmlFor="iamge2">
                    ...
                    type="file" id="iamge2" hidden />
                </label>

                <label htmlFor="iamge3">
                    <img className='w-20'
                       src={!image3?assets.upload_area:URL.createObjectURL(image3)} 
                     alt="" />
                    <input
                        onChange={(e)=>setImage3(e.target.files[0])}
                      type="file" id="iamge3" hidden />
                </label>

                <label htmlFor="iamge4">
                    <img className='w-20'
                        src={!image4?assets.upload_area:URL.createObjectURL(image4)}
                      alt="" />
                    <input 
                       onChange={(e)=>setImage4(e.target.files[0])}
                    type="file" id="iamge4" hidden />
                </label>
            </div>
         </div>
         ...
         <div className='mb-3'>
          ...
          <button
          className='w-28 py-3 mt-4 bg-black text-white' type='submit'>ADD</button>
    </form>
  )
}
